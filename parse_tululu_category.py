...
def main():
    ...
    parser.add_argument('--end_page', default=701, type=int, help='Конечная страница')
    parser.add_argument('--dest_folder', type=str, help='Папка для скачивания книг и картинок')
    ...
    if args.dest_folder:
        books_path = args.dest_folder
        images_path = args.dest_folder
    else:
        books_path = 'books'
        images_path = 'images'
    ...
    for book_link in book_links:
        ...
        try:
            ...
            with open(filepath_json, 'a') as my_file:
